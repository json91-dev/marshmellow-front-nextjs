...
import style from './mallowMissionBottomSheet.module.scss';
import React, { useCallback, useEffect, useRef } from 'react';
import useBottomSheet from '@/app/_hook/useBottomSheet';
import Image from 'next/image';

export default function MallowMissionBottomSheet() {
  const { isShowMallowMissionBottomSheet, showMallowMissionBottomSheet } = useModalStore();
  ...
  const { closeBottomSheet } = useBottomSheet({
    bottomSheetRef,
    backDropRef,
    isShow: isShowMallowMissionBottomSheet,
    setIsShow: showMallowMissionBottomSheet,
  });
  ...
  useEffect(() => {
    showMallowMissionBottomSheet(true);
  }, []);

  return (
    <>
      <CSSTransition in={isShowMallowMissionBottomSheet} timeout={200} unmountOnExit>
        <ModalBackdrop ref={backDropRef} />
      </CSSTransition>

      <CSSTransition
        in={isShowMallowMissionBottomSheet}
        timeout={200}
